...
export default class extends Controller {
    ...
    /**
     * Stimulus action: data-action="click->pick-location#useCurrentLocation"
     * Uses browser geolocation to place marker at user's current position
     */
    useCurrentLocation(event) {
        ...
        navigator.geolocation.getCurrentPosition(
            (position) => {
                ...
                this._placeMarker(latlng, { pan: false });
    ...
    _placeMarker(latlng, { pan = true } = {}) {
        const icon = this._dotIcon(28, "#660033");
