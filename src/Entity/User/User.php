...
class User implements UserInterface, PasswordAuthenticatedUserInterface, Stringable, UpdatedAtInterface
{
    ...
    #[ORM\OneToMany(mappedBy: 'owner', targetEntity: EventGroupDiscussionComment::class)]
    private Collection $eventDiscussionComments;

    #[ORM\OneToMany(mappedBy: 'owner', targetEntity: EventGroupDiscussionCommentVote::class)]
    ...
    public function addEventDiscussionComment(EventGroupDiscussionComment $eventDiscussionComment): static
    {
    ...
    public function removeEventDiscussionComment(EventGroupDiscussionComment $eventDiscussionComment): static
    {
