...
#[ORM\Entity(repositoryClass: EventDiscussionRepository::class)]
class EventGroupDiscussion
{
    ...
    #[ORM\OneToMany(mappedBy: 'discussion', targetEntity: EventDiscussionComment::class, cascade: ['persist', 'remove'])]
    ...
    public function addComment(EventDiscussionComment $comment): static
    {
    ...
    public function removeComment(EventDiscussionComment $comment): static
    {
