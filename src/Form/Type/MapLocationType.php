    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            ...
            'empty_data' => function (FormInterface $form): MapLocationDto {
                $latData = $form->get('latitude')->getData();
                $lngData = $form->get('longitude')->getData();

                // Handle empty strings and null values - convert to null for validation
                $lat = ($latData !== null && $latData !== '') ? (float) $latData : null;
                $lng = ($lngData !== null && $lngData !== '') ? (float) $lngData : null;
        ...
        $resolver->setAllowedTypes('event', [EventDto::class, 'null']);
